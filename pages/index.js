...
export default function Home() {
  ...
  let [showInvest, setShowInvest] = useState(true);
  return (
    <Layout>
      <div className="pt-24">
      ...
      <section className="flex bg-white text-black flex-wrap justify-content">
